  ...
  <div className="vending-popout-section">
    <div className="vending-popout-content">
      ...
      <div className="vending-popout-center">
        <div className="vending-popout-subtitle">Fully Stocked & Maintained Machines</div>
        <img src={micromartImage} alt="Micromart Vending Machine" className="vending-popout-img" />
